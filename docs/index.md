...
<img src="assets/johan.JPG" align="left" width="180" style="border-radius: 50%; border: 4px solid #3d4f5d; margin-right: 25px; margin-bottom: 20px;">
...
[View Full CV :material-account-details:](cv.md){ .md-button .md-button--primary } [View Research :material-arrow-right:](research.md){ .md-button }